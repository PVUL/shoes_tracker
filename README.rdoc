...
7/4 - New branch "delete-shoes"
      spec file created for tdd
      create feature for user to delete shoes
      technically, it will not delete the shoe
      it will delete the user_id-shoe_id relationship
